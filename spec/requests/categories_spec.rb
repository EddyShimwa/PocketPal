...
RSpec.describe 'Categories', type: :request do
  ...
  let(:user) { User.create(name: 'eddy', email: 'eddy@mail.com', password: 'password', confirmed_at: Time.now) }
  let(:category) do
    Category.create(id: 1, name: 'Food', icon: 'https://cdn-icons-png.flaticon.com/512/5141/5141534.png',
                    user_id: user.id)
  end
